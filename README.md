...
The columns aim to display educational outcomes. We can see this by looking at this sample line
School District,Liberty Union High,761721.0,2018-2019,Homeless Status,Did Not Experience Homelessness in K-12,Bachelor's Degree - Did Not Transfer,39340.0,56250.0,66698.0,70569.0
This line displays the wages of students from Liberty Union High who did not experience homelessness in k-12 and did not transfer for their Bachelor's Degree. The columns aim to give context to the wages of the populations represented in each line. Each population displays a certain population of students, their specific school district, their unique educational circumstances, such as experiences with homelessness and academic achievements. With this data, it combines it with the wages of the populations following graduation. Regarding related columns, DISTRICT_NAME, DISTRICT_CODE, and DISTRICT_TYPE are all related in that they all combine to represent a single district. DEMO_POPULATION and STUDENT_POPULATION are related in that STUDENT_POPULATION is a category within the DEMO_POPULATION. For example, in the line above, the DEMO_POPULATION is Homeless Status and the STUDENT_POPULATION is Did Not Experience Homelessness in K-12. In a way STUDENT_POPULATION is a subset of the given demographic. Finally, with regard to infering based on the data, AWARD_CATEGORY and the following wages are related in terms of linking a student populations academic achievement with their later achievement financially in the job market.